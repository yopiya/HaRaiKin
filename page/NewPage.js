    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollViewContent}>
        ...
        <View style={styles.containerDetail}>
          ...
          <TouchableOpacity style={{ paddingBottom: 5, paddingTop: 2, paddingBottom: 5 }}>
            <Text style={{ color: 'blue' }}>ดูรีวิวของร้านนี้</Text>
          </TouchableOpacity>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'flex-start', width: '85%' }}>
            <Image
              style={{ width: 60, height: 25, marginTop: 2, marginLeft: -20, marginBottom: 10 }}
